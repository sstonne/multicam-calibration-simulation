...
def send_gripper_and_wait(server, state, mode="full", timeout=3.0, poll=0.05):
...
def main():
    ...
    z_lifted_waypoint = Joint(112.58, -41.56, -75.93,-179.99,  62.51, 112.58)
    zrz_lifted_waypoint = Joint(127.79, -60.00, -39.48,-211.75, 105.20, 126.13)
